 ...
 * per-tests-executable #include search paths and linking. */

/* Add source files to a tests executable's compilation and linking. Ex: TEST_SOURCE_FILE("sandwiches.c") */
#define TEST_SOURCE_FILE(a)

/* Customize #include search paths for a tests executable's compilation. Ex: TEST_INCLUDE_PATH("src/module_a/inc") */
